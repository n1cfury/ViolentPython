...
def main():
	banner()
	parser = optparse.Optionparser("usage%prog "+"-s <src for SYN flood> -S <src for spoofed conenction> -t <target address>")
	...
	parser.add_option('-t', dest='iface', type='string', help='target address')
